import { Button, FormControl, FormHelperText, Grid, Input, InputLabel, Stack, Typography } from "@mui/material"
...
const CrudEdit = <T, >(props: CrudEditProps<T>) => {
    ...
    const renderTextField = (f: CrudEditProps<T>['fields'][0]) => {
        ...
        return (
            ...
            <Input id={f.id.toString()} name={f.name} aria-describedby="my-helper-text" value={val} onChange={onUpdate} />
    ...
    return (
        <Stack direction='column'>
            ...
            <Button disabled={submitting} onClick={submitAction} variant='text'>Submit</Button>
        </Stack>
    )
}
